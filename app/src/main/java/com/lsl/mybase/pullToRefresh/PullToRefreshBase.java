package com.lsl.mybase.pullToRefresh;
...
import com.lsl.mybase.pullToRefresh.ILoadingLayout.State;
    ...
    public void onPullDownRefreshComplete() {
        if (isPullRefreshing()) {
            ...
            if (null != mHeaderLayout) {
                mHeaderLayout.setLastUpdatedLabel(currentTime);
            }

            if (null != mFooterLayout) {
                mFooterLayout.setLastUpdatedLabel(currentTime);
            }
        }
    }
